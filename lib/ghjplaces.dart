...
class _ghjPlacesPageState extends State<ghjPlacesPage> {
  ...
  Widget build(BuildContext context) {
    final List ghjdecodedBody = jsonDecode(
        getIt.get<ghjDataProvider>().prefs.getStringList('places')!.toString());
    return Scaffold(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage(places[index]['images'][0]),
                                fit: BoxFit.cover,
                              )),
                        ),
                        Padding(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '${(places[index]['rating'] + (ghjdecodedBody[index]['rate'] / 100)).toStringAsFixed(2)}',
                                        style: GoogleFonts.inter(
