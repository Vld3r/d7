...
class _ghjfactsPageState extends State<ghjfactsPage> {
  ...
  Widget build(BuildContext context) {
    final List ghjdecodedBody = jsonDecode(
        getIt.get<ghjDataProvider>().prefs.getStringList('facts')!.toString());
    return Scaffold(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage(facts[index]['images'][0]),
                                fit: BoxFit.cover,
                              )),
                        ),
                        Padding(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '${(facts[index]['rating'] + (ghjdecodedBody[index]['rate'] / 100)).toStringAsFixed(2)}',
                                        style: GoogleFonts.inter(
